        ...
        <header className="flex justify-between items-center px-3 max-w-6xl mx-auto">
            ...
            <div>
                <ul className="flex space-x-10">
                    ...
                    <li className={`py-4 text-sm font-semibold text-gray-400 border-b-[3px] border-white cursor-pointer ${activeRoute("/sign-in") && "text-neutral-800 border-b-red-500"}`} onClick={()=>navigate('/sign-in')}>Sign In</li>
                </ul>
            </div>
        </header>
    </div>
