  ...
  return (
    <main className="max-w-md px-2 mx-auto">
        ...
        <form>
            ...
            <textarea id="address" onChange={onChange} placeholder="Address" required className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6" >{address}</textarea>
            <p className="text-lg font-semibold">Description</p>
            <textarea id="description" onChange={onChange} placeholder="Description" required className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6" >{description}</textarea>
